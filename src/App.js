...
// URLs: confirmed .co.uk live = motor, magic, cannabin, travel, sail, radi
// GitHub Pages used for the rest until .co.uk domains are wired up
const OID_NETWORK = [
    ...
    { name: 'Watch-Oid', emoji: '⌚', url: 'https://chrispteemagician.github.io/watch-oid', tagline: 'AI watch identifier', keywords: ['watch','timepiece','chronograph','rolex','seiko','omega','casio','citizen','timex','wristwatch','pocket watch','movement','dial','bezel','bracelet','strap','clasp','automatic','quartz','mechanical','horology'] },
    ...
    { name: 'Vinyl-Oid', emoji: '🎵', url: 'https://chrispteemagician.github.io/vinyl-oid', tagline: 'AI vinyl record identifier', keywords: ['vinyl','record','lp','ep','7"','12"','7 inch','12 inch','pressing','first press','gatefold','rpm','45rpm','33rpm','shellac','78','sleeve','picture disc'] },
    { name: 'Guit-Oid', emoji: '🎸', url: 'https://chrispteemagician.github.io/guit-oid', tagline: 'AI guitar & instrument identifier', keywords: ['guitar','bass guitar','ukulele','mandolin','banjo','fender','gibson','stratocaster','telecaster','les paul','acoustic','electric guitar','effects pedal','pickup','humbucker','single coil','amplifier','amp'] },
    { name: 'Coin-Oid', emoji: '🪙', url: 'https://chrispteemagician.github.io/coin-oid', tagline: 'AI coin & medal identifier', keywords: ['coin','medal','numismatic','bullion','sovereign','crown','penny','shilling','florin','farthing','sixpence','halfpenny','gold coin','silver coin','proof coin','uncirculated','mint condition','obverse','reverse'] },
    { name: 'Stamp-Oid', emoji: '📮', url: 'https://chrispteemagician.github.io/stamp-oid', tagline: 'AI stamp identifier', keywords: ['stamp','postage stamp','philately','philatelic','overprint','perforated','imperforate','first day cover','royal mail','postal','franked','mint stamp','used stamp'] },
    ...
    { name: 'Miniature-Oid', emoji: '🐉', url: 'https://chrispteemagician.github.io/miniature-oid', tagline: 'AI miniature & figurine identifier', keywords: ['miniature','figurine','warhammer','model','diorama','toy soldier','pewter','resin','40k','age of sigmar','dungeons and dragons','d&d','rpg','citadel','painted miniature'] },
    { name: 'Designer-Oid', emoji: '👜', url: 'https://chrispteemagician.github.io/designer-oid', tagline: 'AI designer item identifier', keywords: ['designer','luxury','handbag','gucci','louis vuitton','lv','prada','chanel','hermes','dior','versace','burberry','coach','mulberry','branded','authentic','genuine leather','dust bag'] },
    { name: 'Camera-Oid', emoji: '📷', url: 'https://chrispteemagician.github.io/camera-oid', tagline: 'AI camera & lens identifier', keywords: ['camera','lens','photography','film camera','dslr','mirrorless','nikon','canon','sony','fuji','fujifilm','leica','olympus','pentax','minolta','rangefinder','slr','medium format','darkroom','enlarger'] },
    ...
    { name: 'Fish-Oid', emoji: '🐟', url: 'https://chrispteemagician.github.io/fish-oid', tagline: 'AI fish & tackle identifier', keywords: ['fish','fishing','tackle','rod','reel','lure','fly fishing','bait','taxidermy fish','stuffed fish','fishing equipment','spinning rod','sea fishing','coarse fishing','feeder'] },
    { name: 'Cannabin-Oid', emoji: '🌿', url: 'https://cannabin-oid.co.uk', tagline: 'AI cannabis strain identifier', keywords: ['cannabis','strain','terpene','cbd','thc','indica','sativa','hybrid','bud','flower','hemp','weed','hash','resin','trichome'] },
];
