...
const SpicyLister = () => {
  ...
  const analyzeMedia = async () => {
    ...
    setTimeout(() => {
      setProcessing(false);
      setResult({
        title: isPro ? "🔥 Premium NeuroSpicy LED String Lights - USB, Mood, ADHD-Friendly!" :
          "LED String Lights, Great for Mood Lighting",
        description: isPro
          ? `🌶️ Listing generated by SpicyLister PRO!\n\n✔️ 2M RGB fairy lights with remote\n✔️ USB powered - plug anywhere\n✔️ Perfect for bedroom, van, shed, comedy shows\n\nProfessionally tested by a neurospicy mind!`,
